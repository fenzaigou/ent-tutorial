...
func (ec *executionContext) field_Query_todos_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["orderBy"]; ok {
		...
		arg4, err = ec.unmarshalOTodoOrder2ᚕᚖtodoᚋentᚐTodoOrderᚄ(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalInputCreateTodoInput(ctx context.Context, obj interface{}) (ent.CreateTodoInput, error) {
	...
	fieldsInOrder := [...]string{"text", "createdAt", "status", "priority", "parentID", "childIDs", "createChildren"}
...
func (ec *executionContext) unmarshalInputUpdateTodoInput(ctx context.Context, obj interface{}) (ent.UpdateTodoInput, error) {
	...
	fieldsInOrder := [...]string{"text", "status", "priority", "parentID", "clearParent", "addChildIDs", "removeChildIDs", "clearChildren"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalNTodoOrder2ᚖtodoᚋentᚐTodoOrder(ctx context.Context, v interface{}) (*ent.TodoOrder, error) {
...
func (ec *executionContext) unmarshalOTodoOrder2ᚕᚖtodoᚋentᚐTodoOrderᚄ(ctx context.Context, v interface{}) ([]*ent.TodoOrder, error) {
	if v == nil {
		return nil, nil
	}
	var vSlice []interface{}
	...
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalNTodoOrder2ᚖtodoᚋentᚐTodoOrder(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
